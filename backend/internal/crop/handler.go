...
func (h *Handler) List(w http.ResponseWriter, r *http.Request) {
	crops, err := h.store.List(r.Context())
	if err != nil {
		http.Error(w, "failed to list crops", http.StatusInternalServerError)
		return
	}
...
func (h *Handler) Get(w http.ResponseWriter, r *http.Request) {
	...
	crop, err := h.store.GetByID(r.Context(), id)
	if err != nil {
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	crop, err := h.store.Create(r.Context(), req)
	if err != nil {
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	crop, err := h.store.Update(r.Context(), id, req)
	if err != nil {
		http.Error(w, "crop not found", http.StatusNotFound)
		return
	}
